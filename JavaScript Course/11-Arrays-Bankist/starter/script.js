...
Do NOT create a new array, simply loop over the array. Formula: recommendedFood = weight ** 0.75 * 28. (The result is in grams of food, and the weight needs to be in kg)
...
console.log(`${ownersEatTooLittle.join("'s and ")}'s dogs eat too much!`);

// 5.
console.log(
  dogs.some(dog => dog.curFood === dog.recommendedFood) ? 'Some dogs' : 'None'
);
...
console.log(dogs.some(checkEatingOkay) ? 'Some dogs' : 'None');
